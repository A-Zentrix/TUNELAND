      ...
      <div className="border-b border-gray-200 bg-gray-50">
        <div className="px-10 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <img src="/images/avatar_leaderboard.png" alt="Avatar" className="h-10 w-10 rounded-full" />
          </div>
        </div>
      </div>
      ...
      <div className="flex px-6 py-6 gap-2">
        ...
        <div className="w-80 bg-gray-50 rounded-lg p-4 flex flex-col justify-between">
          <div className="flex flex-col gap-4">
            {/* Modules Button */}
            <Link href="/demo" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100">
